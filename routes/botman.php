...
$botman->hears([
	...
	'🎲 Random Dog Image', 
	'/random@{username}'
], 'App\Http\Controllers\AllBreedsController@random');
...
$botman->hears([
	...
	'/bs@{username}', 
	'🖼 A Image by Breed'
], 'App\Http\Controllers\ConversationController@byBreed');
...
$botman->hears([
	...
	'/s@{username}', 
	'/ss@{username}', 
	'🖼 A Image by Sub-Breed'
], 'App\Http\Controllers\ConversationController@bySubBreed');
...
$botman->hears([
	...
	'/help@{username}', 
	'❓ Help Center'
], 'App\Http\Controllers\HelpDeskController@index');
...
$botman->hears([
	...
	'/feedback@{username}', 
	'📄 Review'
], 'App\Http\Controllers\ConversationController@feedback');
